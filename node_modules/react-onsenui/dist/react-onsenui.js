...
})(this, function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_4__, __WEBPACK_EXTERNAL_MODULE_65__) {
...
var SimpleWrapper = function (_BasicComponent) {
  ...
  _createClass(SimpleWrapper, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'disabled');
      _Util2.default.convert(others, 'ripple');

      return _react2.default.createElement(this._getDomNodeName(), others, this.props.children);
    }
  }]);
...
var _onsenui = __webpack_require__(65);
...
var BaseDialog = function (_React$Component) {
  ...
  _createClass(BaseDialog, [{
    ...
    value: function renderPortal(props, isShown) {
      ...
      var newProps = _objectWithoutProperties(props, []);

      _Util2.default.convert(newProps, 'isCancelable', { newName: 'cancelable' });
      _Util2.default.convert(newProps, 'isDisabled', { newName: 'disabled' });
      _Util2.default.convert(newProps, 'maskColor', { newName: 'mask-color' });
      _Util2.default.convert(newProps, 'animationOptions', { fun: _Util2.default.animationOptionsConverter, newName: 'animation-options' });

      var DomNodeName = this._getDomNodeName();

      _reactDom2.default.unstable_renderSubtreeIntoContainer(this, _react2.default.createElement(DomNodeName, newProps), this.node, this._update.bind(this, isShown, onDeviceBackButton));
    }
  }, {
    key: 'render',
    value: function render() {
...
var _BaseDialog2 = __webpack_require__(6);
...
var Carousel = function (_SimpleWrapper) {
  ...
  _createClass(Carousel, [{
    ...
    value: function render() {
      ...
      ['fullscreen', 'swipeable', 'disabled', 'centered', 'overscrollable'].forEach(function (el) {
        _Util2.default.convert(others, el);
      });

      _Util2.default.convert(others, 'itemWidth', { fun: _Util2.default.sizeConverter, newName: 'item-width' });
      _Util2.default.convert(others, 'itemHeight', { fun: _Util2.default.sizeConverter, newName: 'item-height' });
      _Util2.default.convert(others, 'autoScroll', { newName: 'auto-scroll' });
      _Util2.default.convert(others, 'autoRefresh', { newName: 'auto-refresh' });
      _Util2.default.convert(others, 'autoScrollRatio', { newName: 'auto-scroll-ratio' });
      _Util2.default.convert(others, 'index', { newName: 'initial-index' });
      _Util2.default.convert(others, 'animationOptions', { fun: _Util2.default.animationOptionsConverter, newName: 'animation-options' });
...
var _BaseInput2 = __webpack_require__(8);
  ...
  _createClass(Checkbox, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['checked']);

      other['input-id'] = this.props.inputId;

      _Util2.default.convert(other, 'disabled');

      return _react2.default.createElement('ons-checkbox', _extends({ checked: checked ? '' : null }, other));
    }
  }, {
    key: 'EVENT_TYPES',
    get: function get() {
...
var Col = function (_SimpleWrapper) {
  ...
  _createClass(Col, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'verticalAlign', { newName: 'vertical-align' });
      _Util2.default.convert(others, 'width', { fun: _Util2.default.sizeConverter });
...
var Icon = function (_SimpleWrapper) {
  ...
  _createClass(Icon, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'fixedWidth', { newName: 'fixed-width' });
      _Util2.default.convert(others, 'spin');
...
var Input = function (_BaseInput) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('ons-input', other);
    }
  }]);
...
var ListItem = function (_SimpleWrapper) {
  ...
  _createClass(ListItem, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'tappable');
      _Util2.default.convert(others, 'tapBackgroundColor', { newName: 'tap-background-color' });
      _Util2.default.convert(others, 'lockOnDrag', { newName: 'lock-on-drag' });
...
var Modal = function (_BasicComponent) {
  _inherits(Modal, _BasicComponent);
  ...
  _createClass(Modal, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _get(Modal.prototype.__proto__ || Object.getPrototypeOf(Modal.prototype), 'componentDidMount', this).call(this);
      this.node = _reactDom2.default.findDOMNode(this);
...
Modal.propTypes = {
   ...
   *   [/en]
   */
  animation: _propTypes2.default.oneOf(['none', 'fade']),
  ...
  _createClass(Page, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['contentStyle']);
...
var ProgressBar = function (_SimpleWrapper) {
  ...
  _createClass(ProgressBar, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'indeterminate');
      _Util2.default.convert(others, 'secondaryValue', { newName: 'secondary-value' });
...
var PullHook = function (_BasicComponent) {
  ...
  _createClass(PullHook, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'height', { fun: _Util2.default.sizeConverter });
      _Util2.default.convert(others, 'thresholdHeight', { fun: _Util2.default.sizeConverter, newName: 'threshold-height' });
      _Util2.default.convert(others, 'fixedContent', { newName: 'fixed-content' });

      return _react2.default.createElement('ons-pull-hook', _extends({ ref: function ref(pullHook) {
...
var Radio = function (_BaseInput) {
  ...
  _createClass(Radio, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('ons-radio', _extends({ checked: checked ? '' : null }, other));
    }
  }, {
    key: 'EVENT_TYPES',
    get: function get() {
...
var Range = function (_SimpleWrapper) {
  _inherits(Range, _SimpleWrapper);
  ...
  function Range() {
    ...
    var _this = _possibleConstructorReturn(this, (_ref = Range.__proto__ || Object.getPrototypeOf(Range)).call.apply(_ref, [this].concat(args)));
  ...
  _createClass(Range, [{
    ...
    value: function componentDidMount() {
      ...
      _get(Range.prototype.__proto__ || Object.getPrototypeOf(Range.prototype), 'componentDidMount', this).call(this);
      var node = _reactDom2.default.findDOMNode(this);
...
var SearchInput = function (_BaseInput) {
  ...
  _createClass(SearchInput, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('ons-search-input', other);
    }
  }]);
 ...
 * </Segment>
 */
var Segment = function (_SimpleWrapper) {
  _inherits(Segment, _SimpleWrapper);
  ...
  _createClass(Segment, [{
    ...
    value: function render() {
      ...
      _Util2.default.convert(others, 'index', { newName: 'active-index' });
      _Util2.default.convert(others, 'tabbarId', { newName: 'tabbar-id' });
...
var Select = function (_BasicComponent) {
  _inherits(Select, _BasicComponent);
  ...
  _createClass(Select, [{
    ...
    value: function componentDidMount() {
      ...
      _get(Select.prototype.__proto__ || Object.getPrototypeOf(Select.prototype), 'componentDidMount', this).call(this);
      var node = _reactDom2.default.findDOMNode(this);
    ...
    value: function render() {
      ...
      return _react2.default.createElement('ons-select', _extends({ checked: checked ? '' : null }, other));
    }
  }]);
...
var SplitterSide = function (_BasicComponent) {
  ...
  _createClass(SplitterSide, [{
    ...
    value: function render() {
      ...
      ['animation', 'swipeable', 'side', 'mode'].forEach(function (el) {
        return _Util2.default.convert(props, el);
      });
      _Util2.default.convert(props, 'width', { fun: _Util2.default.sizeConverter });
      _Util2.default.convert(props, 'animationOptions', { fun: _Util2.default.animationOptionsConverter, newName: 'animation-options' });
      _Util2.default.convert(props, 'openThreshold', { newName: 'open-threshold' });
      _Util2.default.convert(props, 'swipeTargetWidth', { fun: _Util2.default.sizeConverter, newName: 'swipe-target-width' });
...
var Switch = function (_BasicComponent) {
  _inherits(Switch, _BasicComponent);
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          other = _objectWithoutProperties(_props, ['checked', 'inputId']);
      ...
      return _react2.default.createElement('ons-switch', _extends({ ref: function ref(switchElement) {
...
var Tabbar = function (_BasicComponent) {
  ...
  _createClass(Tabbar, [{
    ...
    value: function render() {
      ...
      var tabs = props.renderTabs(props.index, this);
      ...
      ['animation', 'swipeable'].forEach(function (el) {
        return _Util2.default.convert(props, el);
      });
      _Util2.default.convert(props, 'animationOptions', { fun: _Util2.default.animationOptionsConverter, newName: 'animation-options' });
      _Util2.default.convert(props, 'tabBorder', { newName: 'tab-border' });

      return _react2.default.createElement(
        'ons-tabbar',
        _extends({}, props, { ref: function ref(tabbar) {
            _this2._tabbar = tabbar;
          } }),
        _react2.default.createElement(
          'div',
          { className: 'ons-tabbar__content tabbar__content' + (props.position === 'top' ? ' tabbar--top__content' : '') },
          _react2.default.createElement(
            'div',
            null,
            this.tabPages
        ...
        _react2.default.createElement(
          'div',
          { className: 'tabbar ons-tabbar__footer ons-tabbar-inner' + (props.position === 'top' ? ' tabbar--top' : '') },
